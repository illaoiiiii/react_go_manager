  ...
  const columns: ColumnsType<Menu.MenuItem> = [
    ...
    },
    {
      ...
      render(_, record) {
        return (
          <Space>
            <AuthButton auth='menu@create' type='text' onClick={() => handleSubCreate(record)}>
              新增
            </AuthButton>
            <AuthButton auth='menu@edit' type='text' onClick={() => handleEdit(record)}>
              编辑
            </AuthButton>
            <AuthButton auth='menu@delete' type='text' danger onClick={() => handleDelete(record)}>
              删除
            </AuthButton>
          </Space>
        )
